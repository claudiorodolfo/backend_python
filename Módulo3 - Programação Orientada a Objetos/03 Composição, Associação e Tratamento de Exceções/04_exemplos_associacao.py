...
class Funcionario:
    ...
    def definir_departamento(self, departamento):
        ...
        if self.departamento:
            self.departamento.remover_funcionario(self)
        
        self.departamento = departamento
        if departamento:
            departamento.adicionar_funcionario(self)
...
func1.definir_departamento(dept_ti)
func2.definir_departamento(dept_ti)
func3.definir_departamento(dept_ti)

dept_ti.listar_funcionarios()

print(f"\nFolha de pagamento: R${dept_ti.calcular_folha_pagamento():.2f}")

print("\nFuncionários ainda existem sem departamento:")
func1.definir_departamento(None)
